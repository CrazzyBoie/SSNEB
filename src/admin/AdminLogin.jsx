...
const AdminLogin = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (username === 'admin' && password === 'ssnebs2057') {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          />
          <h2 style={{ color: 'var(--color-secondary)', marginBottom: '4px' }}>Admin Login</h2>
          <p style={{ color: 'var(--color-muted)', fontSize: '0.9rem' }}>SSNEBS Management Panel</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button
            ...
            onMouseEnter={e => e.currentTarget.style.background = '#b91c32'}
        ...
        {/* <div style={{
          ...
          <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--color-muted)' }}>
            ...
            Username: <code style={{ color: 'var(--color-primary)' }}>admin</code><br />
            Password: <code style={{ color: 'var(--color-primary)' }}>ssnebs2057</code>
          </p>
        </div> */}
      </div>
    </div>
