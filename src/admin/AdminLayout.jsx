...
import { FaHome, FaImages, FaBullhorn, FaNewspaper, FaChalkboardTeacher, FaPhotoVideo, FaComments, FaTrophy, FaCog, FaSignOutAlt, FaBars, FaClipboardList, FaFileAlt } from 'react-icons/fa';
      ...
      <aside className="admin-sidebar" style={{
        ...
        <div style={{ padding: '24px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <img src={LOGO_BASE64} alt="Logo" style={{ width: '40px', height: '40px', borderRadius: '50%' }} />
            <div>
      ...
      <div className="admin-content" style={{
        ...
        <div style={{
          ...
          >
            ...
            <span style={{ color: 'var(--color-muted)', fontSize: '0.9rem' }}>Welcome, Admin</span>
            <button
              onClick={handleLogout}
              style={{
                padding: '8px 16px',
