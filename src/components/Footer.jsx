    ...
    <footer style={{ background: 'var(--color-secondary)', color: 'white' }}>
      ...
      <div className="container" style={{ padding: '60px 20px 40px' }}>
        <div style={{
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.8rem', margin: 0, color: 'var(--color-accent)' }}>English Boarding School</p>
              </div>
            </div>
            <p style={{ fontSize: '0.9rem', lineHeight: 1.6, color: '#cbd5e1', marginBottom: '20px' }}>
          ...
          {/* Quick Links */}
          <div>
            <h4 style={{ fontSize: '1.1rem', marginBottom: '20px', color: 'var(--color-accent)' }}>{t('quickLinks')}</h4>
          ...
          {/* Academics */}
          <div>
            <h4 style={{ fontSize: '1.1rem', marginBottom: '20px', color: 'var(--color-accent)' }}>{t('academicsFooter')}</h4>
            <ul style={{ listStyle: 'none', padding: 0 }}>
              {['Nursery & KG', 'Primary (1-5)', 'Lower Secondary (6-8)', 'Secondary (9-10)', '+2 Science', '+2 Management'].map(item => (
                <li key={item} style={{ marginBottom: '10px', color: '#cbd5e1', fontSize: '0.9rem' }}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          {/* Contact Info */}
          <div>
            <h4 style={{ fontSize: '1.1rem', marginBottom: '20px', color: 'var(--color-accent)' }}>{t('contactInfo')}</h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                <FaMapMarkerAlt style={{ color: 'var(--color-accent)', marginTop: '3px', flexShrink: 0 }} />
                <span style={{ fontSize: '0.9rem', color: '#cbd5e1' }}>{siteSettings?.address || t('address')}</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <FaPhone style={{ color: 'var(--color-accent)', flexShrink: 0 }} />
                <span style={{ fontSize: '0.9rem', color: '#cbd5e1' }}>{siteSettings?.phone || t('phone')}</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <FaEnvelope style={{ color: 'var(--color-accent)', flexShrink: 0 }} />
                <span style={{ fontSize: '0.9rem', color: '#cbd5e1' }}>{siteSettings?.email || t('email')}</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <FaClock style={{ color: 'var(--color-accent)', flexShrink: 0 }} />
                <span style={{ fontSize: '0.9rem', color: '#cbd5e1' }}>{siteSettings?.officeHours || t('officeHours')}</span>
              </div>
            </div>
          </div>
        </div>
